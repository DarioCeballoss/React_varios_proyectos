...
import logotgifhome from './img/logotgifhome.jpg';
    ...
    <div>
      <section className="row">
        <article className="col">
          ...
          <div className={show ? 'show' : 'not-show'}>
            ...
            <p>Open government is widely seen to be a key hallmark of contemporary democratic practice and is often linked
              ...
              freedom of information legislation, dating the origins of its modern provisions to the eighteenth century
              and
        ...
        <article className="col">
          ...
          <img src={logotgifhome} alt="LUPA" className="lupa" />
        </article>
